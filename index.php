...
<p align="center">&nbsp;</p>
  <?php if ($_SESSION['MM_UserGroup']=='Administrateurs' or $_SESSION['MM_UserGroup']=='Contributeurs' or $_SESSION['MM_UserGroup']=='Formateurs') { ?><a href="http://www.cyclede-corp.fr/front/contribute/new_actualite.php"><input type="submit" name="Nouvelle actualit&eacute;" id="Nouvelle actualit&eacute;" value="Nouvelle actualit&eacute" class="submit">
  </a><?php } ?>
<p align="center">&nbsp;</p>
<table width="50" border="0" align="center">
  <tr class="Style7">
    <?php if ($pageNum_news > 0) { // Show if not first page ?>
    <th scope="col"><a href="<?php printf("%s?pageNum_news=%d%s", $currentPage, 0, $queryString_news); ?>"><img src="http://www.cyclede-corp.fr/images/first.png" width="12" height="10" /></a></th>
    <th scope="col"><a href="<?php printf("%s?pageNum_news=%d%s", $currentPage, max(0, $pageNum_news - 1), $queryString_news); ?>"><img src="http://www.cyclede-corp.fr/images/left.png" width="10" height="10" /></a></th>
    ...
    <th scope="col"><a href="<?php printf("%s?pageNum_news=%d%s", $currentPage, min($totalPages_news, $pageNum_news + 1), $queryString_news); ?>"><img src="http://www.cyclede-corp.fr/images/right.png" width="10" height="10" /></a></th>
    <th scope="col"><a href="<?php printf("%s?pageNum_news=%d%s", $currentPage, $totalPages_news, $queryString_news); ?>"><img src="http://www.cyclede-corp.fr/images/last.png" width="12" height="10" /></a></th>
...
<table width="60%" align="center" class="tab_cadrehov">
  <tbody>
    <tr class="noHover">
      ...
      <td width="32" rowspan="2"><label><a href="http://www.cyclede-corp.fr/front/contribute/modif_actualite.php?id=<?php echo $row_news['id']; ?>"><img src="http://www.cyclede-corp.fr/images/modif.png" width="29" height="29" align="middle"></a></label></td>
      <?php } ?>
    </tr>
    <tr>
